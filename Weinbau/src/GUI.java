...
public class GUI extends JFrame {
	...
	public void fenster1() {
		...
		JButton neuerWeinberg = new JButton("Neuen Weinberg hinzuf�gen");
	...
	public void fenster2(Weinberg weinberg) {
		...
		eins = new JPanel(new GridLayout(2,1/*AnzahlWarnungen*/)); // �berschriften /Warnungen...
		...
		drei.add(new JButton("Bew�sserung starten"),BorderLayout.SOUTH);
